package com.seiii.backend_511.config;
...
@Configuration
// 扫描 Mapper 接口并容器管理
@MapperScan(basePackages = com.seiii.backend_511.config.DataSourceConfig.PACKAGE,sqlSessionFactoryRef = "testDsSqlSessionFactory")
public class DataSourceConfig {

    // 精确到 cluster 目录，以便跟其他数据源隔离
    static final String PACKAGE = "com.seiii.backend_511.mapperservice";
    static final String MAPPER_LOCATION = "classpath:mapper/*.xml";
    static final String ALIAS = "com.seiii.backend_511.po";
